...
public class DriverService {
    ...
    public ResponseEntity<?> updateDriver(String id,Driver driver){
        ...
        if(driverData.isPresent()){
                ...
                if(driverData.get().getName().equals(driver.getName())){
                    ...
                    driverData.get().setName(driver.getName());
                    if (driverRepository.existsByName(driverData.get().getName())) {
                        return ResponseEntity
                                .badRequest()
                                .body(new MessageResponse("Error: Driver already created with this name!"));
                    }
