...
public class VehicleServicesController {
   ...
   @GetMapping("/getByNameService/{name}")
    ...
    @GetMapping("/getVehicleServices/{id}")
    public List<VehicleServices> getAllVehicleService(@PathVariable List<String> id) {
        return  servServices.getAllVehicleServices(id);
    }
}
