...
public class VehicleClassController {
    ...
    @PutMapping ("/vehicleClass/update/{id}")
    public ResponseEntity<VehicleClass> updateVehicle(@PathVariable String id, @RequestBody VehicleClass vehicle){
        return  vehicleClassService.updateVehicleclass(vehicle,id);
    }
