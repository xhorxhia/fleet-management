...
//    }
    ...
    public List<List<VehicleIssue>>findById(@PathVariable("id") String companyId){
    ...
    @GetMapping("/issues/{vehicleId}")
    public ResponseEntity<List<VehicleIssue>> findByvehicleId(@PathVariable("vehicleId") String vehicleId){
        return vehicleIssueService.findByVehicleID(vehicleId);
    }
